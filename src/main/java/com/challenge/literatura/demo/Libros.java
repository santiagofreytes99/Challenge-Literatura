...
public class Libros {
    ...
    public Libros(String titulo, Idioma idioma, Integer numeroDeDescargas, String enlace) {
        this.titulo = titulo;
        this.idioma = idioma;
    ...
    public Libros(LibrosRecord libro) {
        this.titulo = libro.titulo();

        Optional<AutoresRecord> autor = libro.autores().stream().findFirst();
